...
public class ErrorCode {
    ...
    public enum ENUM_ERROR {
        ...
        OU00011("OU00011", "错误,请重试!", "代付订单时,代付数据为空!"),
        OU00012("OU00012", "错误,请重试!", "代付订单时,未筛选出可用的代付!"),
        OU00013("OU00013", "错误,请重试!", "代付订单时,订单属于黑名单信息!"),
         ...
         * ZB表示众邦白名单check校验
         **********************************************/
        ZB00001("ZB00001", "错误,请重试!", "添加众邦白名单时,所有数据都为空!"),
        ZB00002("ZB00002", "白名单流水序号不能为空!", "添加众邦白名单时,白名单流水序号为空!"),
        ZB00003("ZB00003", "用户姓名不能为空!", "添加众邦白名单时,用户姓名为空!"),
        ZB00004("ZB00004", "身份证号不能为空!", "添加众邦白名单时,身份证号为空!"),
        ZB00005("ZB00005", "身份证正面照片URL不能为空!", "添加众邦白名单时,身份证正面照片URL为空!"),
        ZB00006("ZB00006", "身份证反面照片URL不能为空!", "添加众邦白名单时,身份证反面照片URL为空!"),
        ZB00007("ZB00007", "手机号不能为空!", "添加众邦白名单时,手机号为空!"),
        ZB00008("ZB00008", "银行卡号不能为空!", "添加众邦白名单时,银行卡号为空!"),
        ZB00009("ZB00009", "数据同步地址不能为空!", "添加众邦白名单时,数据同步地址为空!"),
        ZB00010("ZB00010", "签名不能为空!", "添加众邦白名单时,签名为空!"),
        ZB00011("ZB00011", "签名错误!", "添加众邦白名单时,签名错误!"),
