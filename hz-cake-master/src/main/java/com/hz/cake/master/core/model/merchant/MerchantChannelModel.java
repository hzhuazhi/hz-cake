...
/**
 * @Description 卡商与渠道/商户的关联关系：代付时卡商与渠道的绑定关系的实体属性Bean
 * @Author yoko
 * @Date 2020/10/29 16:01
 * @Version 1.0
 */
public class MerchantChannelModel extends BasePage implements Serializable {
    private static final long   serialVersionUID = 1203223202101L;
